...
import 'package:firestore_poc_whapp/firebase_options.dart';
import 'package:firestore_poc_whapp/pages/chat_room.dart';
import 'package:firestore_poc_whapp/pages/login_page.dart';
...
void main() async {
  ...
  await instance.requestNotificationPermissions();
  await instance.subscribeToTopic("orders-123123-081218180250");
